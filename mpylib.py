...
rc = mpl.rc
rc('font', size=24, weight='medium') 
rc('figure', dpi=100, facecolor='whitesmoke', titlesize=27, titleweight='medium') 
rc('axes', titlecolor='k', titlesize=25, titleweight='regular', titlepad=15, labelpad=15)
rc('axes', facecolor='#e6e6e6', labelcolor='r', grid=True) 
...
def closestDateTimeTo(elapsed_time:int|float, in_dataframe:pd.DataFrame): 
    df = in_dataframe
    dtTmRslt = None
    if not(df.empty):
